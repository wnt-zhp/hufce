...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HistoricalAdress.user_changed'
        db.alter_column('registry_historicaladress', 'user_changed_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'HistoricalUprawnienie.user_changed'
        db.alter_column('registry_historicaluprawnienie', 'user_changed_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'HistoricalCorresponcence.user_changed'
        db.alter_column('registry_historicalcorresponcence', 'user_changed_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'HistoricalScoutBook.user_changed'
        db.alter_column('registry_historicalscoutbook', 'user_changed_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # Changing field 'HistoricalAdress.user_changed'
        db.alter_column('registry_historicaladress', 'user_changed_id', self.gf('current_user.models.CurrentUserField')(to=orm['auth.User'], null=True))

        # Changing field 'HistoricalUprawnienie.user_changed'
        db.alter_column('registry_historicaluprawnienie', 'user_changed_id', self.gf('current_user.models.CurrentUserField')(to=orm['auth.User'], null=True))

        # Changing field 'HistoricalCorresponcence.user_changed'
        db.alter_column('registry_historicalcorresponcence', 'user_changed_id', self.gf('current_user.models.CurrentUserField')(to=orm['auth.User'], null=True))

        # Changing field 'HistoricalScoutBook.user_changed'
        db.alter_column('registry_historicalscoutbook', 'user_changed_id', self.gf('current_user.models.CurrentUserField')(to=orm['auth.User'], null=True))
