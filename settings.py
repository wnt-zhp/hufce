...
STATIC_ROOT = os.path.join(CURR_DIR, 'compiled_static')
...
SECRET_KEY = 'y&)=(vlfpr1d1odlh3s9c000vgg!g-a2od=37$1v--r)pt@^-l'
...
TEMPLATE_DIRS = ('/home/jb/programs/wnt/hufce/templates',)
